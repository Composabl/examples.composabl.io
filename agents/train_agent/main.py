from composabl_core.agent import Agent, Scenario, Sensor, Skill
...
def start():
    ...
    # agent.demo_all_skills(save_directory="/Users/hunterpark/Movies/lunar_lander/before_training")
    agent.train(train_iters=100)
    # agent.demo_all_skills(save_directory="/Users/hunterpark/Movies/lunar_lander/after_training")
