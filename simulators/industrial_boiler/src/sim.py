...
class Env(gym.Env):
    ...
    def reset(
        ...
        self.H_list = [self.H1, self.H2, self.H3, self.H4, self.H5, self.H6, self.H7, self.H8, self.H9]
    ...
    def step(self, action):
        ...
        io_y1 = control.interconnect((io_1, io_2, io_3, sumblk), inputs=['u1', 'u2', 'u3'], output='y')
        ...
        self.fuel_used_yr = ((60 * self.total_fuel_used / self.cnt) * 8 * 22 * 12 / 1000)  # ton/yr estimation
        EF = 2.24 * (10e-3)
