...
class Env(gym.Env):
    ...
    def handle_order(
        self, env, order_target, cost_price=50, delay_days_until_delivery=2
    ):
    ...
    def warehouse_run(
        ...
        while True:
            ...
            if inventory < order_cutoff and num_ordered == 0:
                env.process(
                    self.handle_order(
                        env, order_target, cost_price, delay_days_until_delivery
                    )
                )
    ...
    def step(self, action):
        ...
        self.obs = {
            "inventory": self.inventory_level[-1],
